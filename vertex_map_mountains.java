...
public class vertex_map_mountains extends PApplet {
...
float[][] terrain;
float steepness = 0.01f;// 0.01,0.02,0.005,0.013, 100
boolean move = true;
...
public void draw() {
  ...
  text("altitude: " + ((flyingZ*-4.25f)+250), 20, 60);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "vertex_map_mountains" };
    if (passedArgs != null) {
